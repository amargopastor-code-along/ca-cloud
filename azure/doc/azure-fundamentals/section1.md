...
Con el cloud computing las organizaciones pueden almacenar sus datos y ejecutar sus soluciones como mejor les convenga para cunmplir con sus requisitos de negocio.
...
Además, los proveedores ofrecen `seguridad` mediante servicios de copias de datos, recuperación y replicación de los mismos. La mayoría de servicios se basan en la redundancia de servicio (tolerancia a fallos: el servicio se continúa aunque caiga un servidor). Los servicios de redundancia de datos son centros distribuidos por distintas regiones del mundo, lo que permite una respuesta geográfica más cercana.
...
`OPEX`: inversión en servicios o productos en este momento y su facturación. No hay costo inicial y se paga por el servicio o producto a medida que se emplea.
